...
The root POC opens raw L2CAP sockets and changes the volatile device class; the
regular daemon and GUI still run unprivileged. No firmware/NVM is modified.
...
centers match the emulated factory calibration. There is no gamepad input capture,
GUI control or generic ControllerState API yet.
